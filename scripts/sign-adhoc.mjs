...
const dir = path.join(process.env.RELEASE_DIR || path.join(os.homedir(), 'desktop-agent-starter-release'), 'mac-arm64');
...
let ids = '';
try { ids = execSync('security find-identity -v -p codesigning', { encoding: 'utf8' }); } catch {}
